...
- **Core modules**: `auth.ts`, `sls-client.ts`, `formatter.ts`, `time-parser.ts`, `query-expander.ts`
- **Config**: `config/mcp.json` stores default project/logstore/region
...
- `config/mcp.json` is checked in and contains default project/logstore/region settings
